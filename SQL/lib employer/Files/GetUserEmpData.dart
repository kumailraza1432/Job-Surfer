...
import 'package:Employer/CustomWidgets/TwoValuesText.dart';
import 'package:Employer/CustomWidgets/txtfeilds.dart';
  ...
  Widget build(BuildContext context) {
    ...
    appBar: JS_AppBar(),
      ...
      floatingActionButton: FloatingActionButton(onPressed: () async {
        ...
        await employer.signUp(m["CNIC"],m["name"],m["userName"],m["DOB"],c,context);
