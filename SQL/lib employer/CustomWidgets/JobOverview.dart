...
import 'package:Employer/Classes/MySQL.dart';
              ...
              Column(
                children: [
                  Padding(
                    ...
                    child: FlatButton(
                      onPressed: () async{
                        Results res = await MySQL.query("select count(*) from  sql6459853.JobAd ,sql6459853.Application "
                            "where JobAd.JobAdID=Application.JobAdID group by JobAd.JobAdID having JobAdID=${j.JobID};",context,removePreContext: false);
			int value= res.isEmpty?0:res.first[0];
                        Navigator.pushNamed(context, '/JobAdsDetails',
                            arguments: {
                              "ad": j,
                              "setState": refreshScreen,
                              "employer": employer,"applications":value
                            });
                      },
                      child: Text("Details"),
                      color: colorThird_G,
