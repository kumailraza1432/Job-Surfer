...
import 'package:applicant/CustomWidgets/AddressWidget.dart';
import 'package:applicant/CustomWidgets/qualification_widget.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Key1("Qualifications", 17.0),
          Padding(
            padding: const EdgeInsets.only(left:50.0),
            child: QualificationWidget(applicant.Qualification),
          )
        ]),
      ),
    );
