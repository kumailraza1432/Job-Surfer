...
import './CustomWidgets/NotificationButton.dart';
dynamic colorThird_G = Colors.teal;
String name_G= "Job Surfer";
dynamic spinner_G = SpinKitFadingCube(color:colorThird_G);
NotificationButton NotificationButton_G=NotificationButton();

showMsg({title="Invalid Entry", msg, context}){showDialog(
    context: context,
